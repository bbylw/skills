...
3. **Reader Testing**: Test the doc with a fresh reader agent (no context) to catch blind spots before others read it
...
**If no integrations are detected and in the provider's assistant app:** Suggest they can enable connectors in their assistant settings to allow pulling context from messaging apps and document storage directly.
...
**If access to sub-agents is available (e.g., in an IDE agent with sub-agents):**
...
**If no access to sub-agents (e.g., provider web interface):**

The user will need to do the testing manually.

### Step 1: Predict Reader Questions

Ask what questions people might ask when trying to discover this document. What would they type into your assistant UI?
...
1. Open a fresh conversation in your provider UI
